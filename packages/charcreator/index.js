const fs = require("fs");
const TeamHandler = require("../Team/index.js")

const saveDirectory = "Aussehen";
const freemodeCharacters = [mp.joaat("mp_m_freemode_01")];
...
mp.events.add("loadchar", (player) => {
    player.loadCharacter();
});

mp.events.add("creator", (player) => {
