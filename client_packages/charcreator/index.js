...
let genderItem = new UIMenuListItem("Gender", "~r~Changing this will reset your customization.", new ItemsCollection(["Male"]));
...
mp.events.add("GGW:Client:Charcreator", () => {
    mp.events.callRemote("creator")
});

mp.events.add("GGW:Client:LoadChar", () => {
    mp.events.callRemote("loadchar")
});